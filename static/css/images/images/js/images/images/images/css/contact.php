...
<!-- Mirrored from autoshed.in/css/images/images/js/images/images/images/css/contact.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 25 Jul 2021 19:35:01 GMT -->
		...
		<div class="row text-center mang_space">
			<div class="col-lg-6  col-md-6  col-sm-6 dark_bg wow fadeInLeft">
				...
				<div class="col-lg-7   col-md-9  col-sm-9 manag_bg">
					<img src="images/manage-service.html">
...
"></a>-->
			...
			<div class="col-lg-6  col-md-6 col-sm-6 wow fadeInDown" style="margin-top: 80px;">
				<div class="col-lg-4   col-md-4  col-sm-4">
					<img src="images/pickup.html">
					<h5>Pick Up/Drop</h5>
				</div>
				<div class="col-lg-4   col-md-4  col-sm-4">
					<img src="images/upfront.html">
