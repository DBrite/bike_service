...
<!-- Mirrored from autoshed.in/css/images/css/css/css/images/images/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 25 Jul 2021 22:16:08 GMT -->
...
<div class="blck_bg spac_bg">
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-sm-4 wow fadeInLeft">
					<img src="images/about-service.html" class="img-responsive">
				</div>
...
<section>
	<div style="background: url(images/workshop.html) no-repeat center top;
    -webkit-background-size: cover;
    -moz-background-size: cover;
    -o-background-size: cover;
    background-size: cover;
    	...
    	<div class="bg_over" style="padding-top:80px;padding-bottom: 80px;">
    		<div class="container">
				...
				<div class="row text-center proces_blk wow fadeInUp">
					<div class="col-lg-3 col-md-3 col-sm-3">
						<p><img src="images/login-icon.html"></p>
						<h4>1. Login / Booking</h4>
					</div>
					<div class="col-lg-3 col-md-3 col-sm-3">
						<p><img src="images/pickup-icon.html"></p>
						<h4>2. Pickup</h4>
					</div>
					<div class="col-lg-3 col-md-3 col-sm-3">
						<p><img src="images/service-icon.html"></p>
						<h4>3. Service</h4>
					</div>
					<div class="col-lg-3 col-md-3 col-sm-3">
						<p><img src="images/delivery-icon.html"></p>
						<h4>4. Delivery</h4>
					</div>
...
<div class="blck_bg">
			...
			<div class="col-lg-5 col-md-5 col-sm-6 wow fadeInLeft" style="padding:0px;">
				<img src="images/whychooseus.html" class="img-responsive">
...
<section id="brands" class="sect_space">
	...
	<div class="container text-center wow fadeInDown">
		...
		<img src="images/brand.html" style="padding:40px 0px;margin: 0px auto" class="img-responsive">		
	</div>
...
<div class="" style="background-color: #000;padding:50px 0px">
	<div class="container foot_ul">
		...
		<div class="col-lg-3 col-md-3 col-sm-3">
			<ul>
				<h4>Download App</h4>
				<a href="https://play.google.com/store/apps/details?id=com.marusatechnologies.autoshed2"><img src="images/google_playstore.html" class="img-responsive"></a>
...
<!-- Mirrored from autoshed.in/css/images/css/css/css/images/images/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 25 Jul 2021 22:16:09 GMT -->
</html>
